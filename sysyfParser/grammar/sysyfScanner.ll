...
{Eq}         {return yy::sysyfParser::make_EQ(loc);}
{Neq}         {return yy::sysyfParser::make_NEQ(loc);}
[<]         {return yy::sysyfParser::make_LT(loc);}
[>]         {return yy::sysyfParser::make_GT(loc);}
{LE}         {return yy::sysyfParser::make_LE(loc);}
{GE}         {return yy::sysyfParser::make_GE(loc);}
...
{FloatConst}            {
                            ...
                            return yy::sysyfParser::make_FLOATCONST(a,loc);
                        }
